...
class TaskConfig(GeneralTaskConfig):
    TASK_TAG: str = "ar_challenge_filter_1500"
...
Core Rule Set:
- Group C: EducationLevelFixed <= 2 and 年龄<=55; Group D: EducationLevelFixed <= 3 and 是否兼任董事==2.

Output File:
- Save one Excel file to {self.output_url}
- Required columns (strict order):
  "证券代码", "股票简称", "C Count", "D Count", "C Avg Salary", "D Avg Salary", "C-D Salary Gap", "C Avg Shareholding 2023", "D Avg Shareholding 2023", "C/D Salary Ratio"
